...
require './lib/interpreters/clustering_process.rb'
...
module OptimizerWrapper
  ...
  def self.define_process(services_vrps, services_fleets = [], job = nil, &block)
    complete_services_vrp = services_vrps.delete_if{ |service_vrp|
      ...
      # splited = Interpreters::ClusteringProcess.split_clusters([service_vrp])
      Interpreters::ClusteringProcess.dbscan_clustering(service_vrp, job){ block }
    }.flatten.compact
